...
async fn main() -> anyhow::Result<()> {
    // --- InfluxDB setup ---
    let influx_url = "http://localhost:8086/api/v2/write?org=almeki&bucket=ali4&precision=s";
    let influx_token = "dEZpJIKV7_AOWS8YUKkDUzdqVC_-Ekg5U3u48esBjwY3jvZM6IOXys1JBCtxWvnNs8PmsdqzPhExAuLb9QLnVg==";
    let http_client = Client::new();

    // --- Ethereum setup ---
    let provider = Provider::<Http>::try_from("http://127.0.0.1:8545")?;
    let wallet: LocalWallet = "0xf257ca1d55f5af7477f1514e8e3770fe0e399e0827785d1d2fa61b742080d399"
